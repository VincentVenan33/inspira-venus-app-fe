...
// import 'package:venus/core/networks/update_customer_dto.dart';
...
//           _currentPage++;
//         }
//         namaController.text = _daftarcustomer[0].vcNama;
//         alamatController.text = _daftarcustomer[0].vcAlamatPenagihan ?? '';
//         // desaController.text = _daftarcustomer[0].desa ?? '';
//         kotaController.text = _daftarcustomer[0].namakota ?? '';
//         // kecamatanController.text = _daftarcustomer[0].kecamatan ?? '';
//         // provinsiController.text = _daftarcustomer[0].provinsi ?? '';
//         nohpController.text = _daftarcustomer[0].vcFaxPenagihan ?? '';
