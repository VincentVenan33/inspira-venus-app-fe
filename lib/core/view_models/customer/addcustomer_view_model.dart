...
import 'package:venus/core/networks/create_customer_dto.dart';
...
class AddCustomerViewModel extends BaseViewModel {
  ...
  Future<bool> addCustomertModel({
    ...
    final response = await _setCustomerDTOApi.setCustomer(
      action: "addCustomer",
      nomormhdesa: _selectedDesa?.intNomor ?? 0,
      nomormhkelurahan: nomormhkelurahan,
      nomormhkecamatan: nomormhkecamatan,
      nomormhkota: nomormhkota,
      nomormhprovinsi: nomormhprovinsi,
      nomormhgelar: _selectedGelar?.intNomor ?? 0,
      nomormhrelasisales: json.decode(userDataJson!)['intNomor'],
      nomormhkategoricustomer: _selectedKategoriCustomer?.intNomor ?? 0,
      nomormhtipeoutlet: _selectedTipeOutlet?.intNomor ?? 0,
      jenis: jenis,
      kode: kode,
      nama: nama,
