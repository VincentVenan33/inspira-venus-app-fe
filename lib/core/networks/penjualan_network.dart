...
import 'package:venus/core/apis/penjualan_api.dart';
import 'package:venus/core/models/authentication/login.dart';
import 'package:venus/core/models/parsed_response.dart';
import 'package:venus/core/models/penjualan/approval_order_penjualan.dart';
  ...
  Future<Either<Failure, ApproveOrderJualResponse>> approveOrderJual({
    ...
    try {
      ...
      final payload = ApproveOrderJualRequest(
        ...
        nomoruser: userData?.user.intNomor ?? 1,
      );
