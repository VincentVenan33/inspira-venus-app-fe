...
class GetOrderJualsResponse {
  ...
  factory GetOrderJualsResponse.fromJson(Map<String, dynamic> json) => _$GetOrderJualsResponseFromJson(json);
...
class ApproveOrderJualRequest {
  ...
  factory ApproveOrderJualRequest.fromJson(Map<String, dynamic> json) => _$ApproveOrderJualRequestFromJson(json);
...
class ApproveOrderJualResponse {
  ...
  factory ApproveOrderJualResponse.fromJson(Map<String, dynamic> json) => _$ApproveOrderJualResponseFromJson(json);
...
class ApprovalMessage {
  ...
  factory ApprovalMessage.fromJson(Map<String, dynamic> json) => _$ApprovalMessageFromJson(json);
...
class SPMessage {
  ...
  factory SPMessage.fromJson(Map<String, dynamic> json) => _$SPMessageFromJson(json);
...
class OrderJual {
  ...
  factory OrderJual.fromJson(Map<String, dynamic> json) => _$OrderJualFromJson(json);
