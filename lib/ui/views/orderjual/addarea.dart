...
class AddAreaOrderJual extends ConsumerStatefulWidget {
  const AddAreaOrderJual({
    super.key,
    required this.viewModel,
  });
  final AddOrderJualViewModel viewModel;
  @override
  ConsumerState<AddAreaOrderJual> createState() => _AddAreaOrderJualState();
}

class _AddAreaOrderJualState extends ConsumerState<AddAreaOrderJual> {
  ...
  Widget build(BuildContext context) {
    return ViewModel<AddOrderJualViewModel>(
      ...
      onModelReady: (AddOrderJualViewModel model) => model.fetchArea(reload: true),
