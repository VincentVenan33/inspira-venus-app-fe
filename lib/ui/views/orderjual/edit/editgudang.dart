...
class EditGudangOrderJual extends ConsumerStatefulWidget {
  const EditGudangOrderJual({
    super.key,
    required this.viewModel,
  });
  final UpdateOrderJualViewModel viewModel;
  @override
  ConsumerState<EditGudangOrderJual> createState() => _EditGudangOrderJualState();
}

class _EditGudangOrderJualState extends ConsumerState<EditGudangOrderJual> {
