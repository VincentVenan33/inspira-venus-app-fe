...
class EditSalesOrderJual extends ConsumerStatefulWidget {
  const EditSalesOrderJual({
    super.key,
    required this.viewModel,
  });
  final UpdateOrderJualViewModel viewModel;
  @override
  ConsumerState<EditSalesOrderJual> createState() => _EditSalesOrderJualState();
}

class _EditSalesOrderJualState extends ConsumerState<EditSalesOrderJual> {
  ...
  Widget build(BuildContext context) {
    return ViewModel<UpdateOrderJualViewModel>(
      ...
      onModelReady: (UpdateOrderJualViewModel model) => model.fetchSales(reload: true),
