...
class AddGudangOrderJual extends ConsumerStatefulWidget {
  const AddGudangOrderJual({
    super.key,
    required this.viewModel,
  });
  final AddOrderJualViewModel viewModel;
  @override
  ConsumerState<AddGudangOrderJual> createState() => _AddGudangOrderJualState();
}

class _AddGudangOrderJualState extends ConsumerState<AddGudangOrderJual> {
  ...
  Widget build(BuildContext context) {
    return ViewModel<AddOrderJualViewModel>(
      ...
      onModelReady: (AddOrderJualViewModel model) => model.fetchGudang(reload: true),
                          ...
                          child: LazyLoadScrollView(
                            ...
                            child: Stack(
                              children: [
                                ListView.builder(
                                  shrinkWrap: true,
                                  itemCount: model.gudang.length,
                                  itemBuilder: (context, index) {
                                    return RadioListTile(
                                      tileColor: venusColor.transparent,
                                      title: Text(
                                        model.gudang[index].vcNama,
                                      ),
                                      groupValue: model.selectedGudang,
                                      value: model.gudang[index],
                                      onChanged: (value) {
                                        setState(() {
                                          model.setselectedgudang(value);
                                        });
