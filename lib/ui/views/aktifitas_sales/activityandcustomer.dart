...
import 'package:venus/core/view_models/aktifitas_sales/activityandcustomer_view_model.dart';
import 'package:venus/core/view_models/view_model.dart';
import 'package:venus/ui/shared/headers_sales.dart';
...
class _ActivitySalesViewState extends ConsumerState<ActivitySalesView> {
                ...
                child: Padding(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: venusColor.cardColorSales, // Set the background color here
  ...
  //                         border: Border.all(
  //                           color: venusColor.lightBlack012,
  //                           width: 1,
  //                         ),
  //                       ),
  //                       child: ElevatedButton(
