...
import 'package:venus/core/view_models/meet/list_pelanggan_view_model.dart';
...
class _ListPelangganViewState extends ConsumerState<ListPelangganView> {
  ...
  Widget _buildButton(
    ...
    Color foregroundColor = isActive ? venusColor.white : venusColor.lightBlack010;
    Color backgroundColor = isActive ? venusColor.lightBlue005 : venusColor.white;
    return Expanded(
      child: ElevatedButton(
        onPressed: onPressed,
        style: ElevatedButton.styleFrom(
