...
extension ButtonTypeExt on ButtonType {
  static const Map<ButtonType, Color> backgroundColors = <ButtonType, Color>{
    ButtonType.primary: venusColor.redPrimary,
    ButtonType.secondary: venusColor.secondary,
  };
  ...
  static const Map<ButtonType, Color> backgroundDisabledColors = <ButtonType, Color>{
    ButtonType.primary: venusColor.lightBlack001,
    ButtonType.secondary: venusColor.lightBlack001,
  };
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      ...
      style: createStyle(
        ...
        foregroundDisabled: venusColor.lightBlack001,
