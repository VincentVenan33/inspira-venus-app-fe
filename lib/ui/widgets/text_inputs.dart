...
class venusTextInput extends StatefulWidget {
  /// Don't use this factory method, instead use `venusDatePicker` widget
  factory venusTextInput.datePicker({
    required TextEditingController controller,
    String? hintText,
    String? label,
    Future<void> Function()? onTap,
  }) {
    return venusTextInput(
  ...
  @override
  State<venusTextInput> createState() => _venusTextInputState();
}

class _venusTextInputState extends State<venusTextInput> {
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                ...
                borderSide: const BorderSide(
                  width: 1,
                  color: venusColor.lightBlack002,
                ),
              ),
